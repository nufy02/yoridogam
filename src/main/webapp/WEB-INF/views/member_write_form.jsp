                        ...
                        <form name="f" method="post">
                       		...
                       		<tr>
								<th width=250 align=center  height="22"> 아이디 : </th>
									<td  align="left" height="22"><input onclick="id_duplicate_check();" type="text" name="m_id" style="width: 200px" placeholder="아이디를 입력해주세요"></td>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
							...
							<tr><th width=140 align=center  height="40"> 비밀번호 : </th>
								<td align="left" height="40"><input type="password" name="m_pass" style="width: 200px" placeholder="비밀번호를 입력해주세요"></td>
							</tr>
							<tr><th width=140 align=center  height="40"> 비밀번호확인 : </th>
								<td align="left" height="40"><input type="password" name="m_pass2" style="width: 200px" placeholder="비밀번호를 입력해주세요"></td>
							</tr>
							...
							<tr><th width=140 align=center  height="22"> 이메일 : </th>
								...
								style="width: 230px" placeholder="이메일을 입력해주세요" ></td>
							</tr>
							<tr><th width=140 align=center  height="20"></th>
							<tr><th width=140 align=center  height="22"> 핸드폰 : </th>
								<td align="left"><input type="text" name="m_phone" style="width: 200px" placeholder="핸드폰번호을 입력하세요"></td>
							</tr>
							...
							<tr><th width=140 align=center  height="22"> 관심분야 : </th>						
							 ...
							 <div class="form-group">
							 	...
							 	<td style="padding-top: 50px;padding-left:200px">                               
							 		<input type="button" class="btn btn-info btn-md" value="가입하기" style="background-color: #FBB710; border-color: #FBB710" onClick="member_write_action()">
                            	</td>
                            	<tr>
                            	</table>
                            </div>                       	
