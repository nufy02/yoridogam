                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="cart-table clearfix" id="check">
							...
							<tr><th width=140 align=center  height="22"> 이름 : </th>
								<td align="left"><input type="text" name="m_name" style="width: 200px" placeholder="이름을 입력해주세요" ></td>
							</tr>
								<tr><th width=140 align=center  height="40"></th>
							...
							<tr>
								<th width=140 align=center  height="22"> 주소 : </th>
									<td align="left" height="22"> <input type="text" id="sample6_postcode" style="width: 100px"placeholder="우편번호">	
										<td>
										<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기">
										</td>
										<tr><th width=140 align=center  height="40"></th>
											<td>
												<input type="text" id="sample6_address" style="width: 300px" placeholder="주소"><br>
											</td>
							<tr>
								<th width=140 align=center  height="22">&nbsp;&nbsp;&nbsp;&nbsp;</th>
								<td><input type="text" id="sample6_detailAddress" style="width: 150px" placeholder="상세주소"></td>
								<td style="padding-left: 40px"><input type="text" id="sample6_extraAddress" style="width: 150px" placeholder="참고항목"></td>
							</tr>
							
							<tr><th width=140 align=center  height="30"></th>
							<tr><th width=140 align=center  height="22"> 이메일 : </th>
								<td align="left"><input type="text" name="m_email" style="width: 230px" placeholder="이메일을 입력해주세요" ></td>
							</tr>
							<tr><th width=140 align=center  height="20"></th>
							<tr><th width=140 align=center  height="22"> 핸드폰 : </th>
								<td align="left"><input type="text" name="m_email" style="width: 200px" placeholder="핸드폰번호을 입력하세요" ></td>
							</tr>
