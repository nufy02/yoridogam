...
감사합니다. ❤', 'admin');
insert INTO NOTICE VALUES(2, '[yoridogam 전체 공지] 개인정보 처리방침 개정안내', '2021-08-03', 6, 
...
insert INTO NOTICE VALUES(3, '[yoridogam 전체 공지] 강사 모집 공고', '2021-08-04', 8, 
'안녕하세요. yoridogam(이하 ‘회사’)입니다.
...
감사합니다.', 'admin');
insert INTO NOTICE VALUES(4, '[오프라인 클래스] 오프라인 클래스 개설 안내', '2021-09-07', 36, 
...
insert INTO NOTICE VALUES(5, '[온라인 클래스] 아빠와 함께하는 강좌 이벤트', '2021-09-18', 36, 
'안녕하세요. yoridogam입니다.
...
감사합니다.', 'admin');
insert INTO NOTICE VALUES(6, '[yoridogam 전체 공지] yoridogam의 아름다운 나눔 이벤트', '2021-09-27', 100, 
'안녕하세요. yoridogam입니다.
...
insert INTO NOTICE VALUES(7, '[yoridogam 전체 공지] 결제 방식의 다양화가 이루어졌습니다.', '2021-10-01', 16, 
'안녕하세요, 요리도감을 사랑해 주시는 고객여러분.
...
많은 참여 부탁드립니다. 감사합니다.', 'admin');
insert INTO NOTICE VALUES(8, '[온/오프 통합] 2021년 11월 강의가 개설되었습니다.', '2021-10-30', 38, 
'안녕하세요, 요리도감을 사랑해 주시는 고객여러분.

요리도감의 11월 강의는 강의 목록에서 확인하실 수 있습니다. 

많은 관심 부탁드립니다.', 'admin');
insert INTO NOTICE VALUES(9, '[온라인 클래스] 2+1 이벤트!', '2021-11-01', 8, 
'안녕하세요. yoridogam입니다.
...
감사합니다.', 'admin');
insert INTO NOTICE VALUES(10, '[온라인 클래스] 2+1 이벤트!', '2021-11-03', 8, '안녕하세요. yoridogam입니다.
...
insert into inquiry	
values(1, '제가 1년 전쯤?? 들은 강의를 확인할 수 있나요??','확인하고 싶은 강의가 있는데 찾기가 어려워서 문의글 씁니다..','2021-08-15',
35,0,1,0,'member1');

insert into inquiry	
values(2, '수업 후 만든 빵은','제가 가지고 가도 되는 거예요?','2021-08-29',
3,0,2,0,'member1');

insert into inquiry	
values(3, '강의 비용에 재료값이 다 들어가져 있나요?','아니면 현장에서 더 결제를 해야 하는 건가요??','2021-09-03',
43,	0,	3,	0,	'member1');

insert into inquiry	
values(4, '안녕하세요 고객님.^^ yoridogam입니다.','안녕하세요 고객님.^^ yoridogam입니다.
...
insert into inquiry	
values(5, '원하는 수업 종류를 신청할 수 있나요?',	'저는 한식도 하고 싶고 간단한 일식도 하고 싶은데 없는 경우가 있더라구요!
더 다양하게 있으면 좋을 것 같아서요..',	'2021-09-14', 23,	0,	5,	0,	'member2');

insert into inquiry	
values(6, '코로나 때문에 신청한 강의가..', 	'취소되면 환불 일정은 어떻게 되는 거예요?','2021-09-20',	
35,	0,	6,	0,	'member1');

insert into inquiry	
values(7, '카카오페이로 결제 되니까 앞으로',	'네이버페이도 곧 들어오게 될 수 있을까요??','2021-10-11',
12,	0,	7,	0,	'member3');

insert into inquiry	
values(8, '안녕하세요 고객님.^^ yoridogam입니다.',	'안녕하세요 고객님.^^ yoridogam입니다.
...
insert into inquiry	
values(10, '제가 진짜 요.알.못인데 수업 따라갈수 있을까요?',	'ㅠㅠ 혹시 뒤쳐지면 민폐잖아용',	'2021-11-01',	
3,	0,	10,	0,	'member1');

insert into inquiry	
values(11,'안녕하세요 고객님.^^ yoridogam입니다.', '"안녕하세요 고객님.^^ yoridogam입니다.
...
insert into inquiry	
values(12, '온라인+오프라인 하나씩 해도', '2+1 이벤트 자동 응모인 거예요? 아니면 온라인만인 거예요??', '2021-11-02',
27,	0,	12,	0,	'member1');

insert into inquiry	
values(13, '안녕하세요 고객님.^^ yoridogam입니다.',	'안녕하세요 고객님.^^ yoridogam입니다.
...
insert into inquiry	
values(14, '빼빼로데이 이벤트 말이에요', '온라인/오프라인 각각 하나씩 결제해도 해당사항 있는 건가요?', 	
'2021-11-05', 	9,	0,	14,	0,	'member1');

insert into inquiry	
values(15, '안녕하세요 고객님.^^ yoridogam입니다.',	'안녕하세요 고객님.^^ yoridogam입니다.
...
insert into inquiry	
values(16, '안녕하세요 고객님.^^ yoridogam입니다.',	'안녕하세요 고객님.^^ yoridogam입니다.
